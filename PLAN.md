...
## [ ] T-01 — Критические баги (timezone + bare except + дубликат) `~30 мин`
...
## [ ] T-02 — Централизация конфигурации `~1 час`
...
## [ ] T-03 — Заменить `print()` на `logging` `~45 мин`
...
## [ ] T-04 — Thread safety для глобальных словарей `~1 час`
